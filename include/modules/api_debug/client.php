...
private function ��������������������������������������������������������N������������������������(string $name, string $pwd): string
{
...
$api_name=(string)$m[1];
$mode=$this->������������������������M��������������������_GET������������������������������������($api_name);
$title=$api_name;
$common_params=array();
$private_params=array();
$content=@file_get_contents($f->getPathname());
if ($content !==false) {
$xml_block=$this->����������������������������switch����������������������������������������������������($content);
if ($xml_block !==null) {
...
private function ������������������������M��������������������_GET������������������������������������(string $api_name): string
{
