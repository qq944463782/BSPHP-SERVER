...
class WxPayResults extends WxPayDataBase
{
	 ...
	 * @param string $param_value
	 */
	public function SetData($key, $param_value)
	{
		$this->values[$key] = $param_value;
	}
	...
	{	
		...
		if($obj->values['return_code'] != 'SUCCESS') {
			foreach ($obj->values as $key => $param_value) {
...
{	
	...
	* @param string $param_value 
	**/
	public function SetAppid($param_value)
	{
		$this->values['appid'] = $param_value;
	}
	/**
	* 获取微信分配的公众账号ID的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetMch_id($param_value)
	{
		$this->values['mch_id'] = $param_value;
	}
	/**
	* 获取微信支付分配的商户号的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetDevice_info($param_value)
	{
		$this->values['device_info'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetNonce_str($param_value)
	{
		$this->values['nonce_str'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetBody($param_value)
	{
		$this->values['body'] = $param_value;
	}
	/**
	* 获取商品或支付单简要描述的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetDetail($param_value)
	{
		$this->values['detail'] = $param_value;
	}
	/**
	* 获取商品名称明细列表的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetAttach($param_value)
	{
		$this->values['attach'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetOut_trade_no($param_value)
	{
		$this->values['out_trade_no'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetFee_type($param_value)
	{
		$this->values['fee_type'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetTotal_fee($param_value)
	{
		$this->values['total_fee'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetSpbill_create_ip($param_value)
	{
		$this->values['spbill_create_ip'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetTime_start($param_value)
	{
		$this->values['time_start'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetTime_expire($param_value)
	{
		$this->values['time_expire'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetGoods_tag($param_value)
	{
		$this->values['goods_tag'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetNotify_url($param_value)
	{
		$this->values['notify_url'] = $param_value;
	}
	/**
	* 获取接收微信支付异步通知回调地址的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetTrade_type($param_value)
	{
		$this->values['trade_type'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetProduct_id($param_value)
	{
		$this->values['product_id'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetOpenid($param_value)
	{
		$this->values['openid'] = $param_value;
	}
	/**
...
class WxPayOrderQuery extends WxPayDataBase
{
	...
	* @param string $param_value 
	**/
	public function SetTransaction_id($param_value)
	{
		$this->values['transaction_id'] = $param_value;
	}
	/**
	* 获取微信的订单号，优先使用的值
	* @return 值
...
class WxPayRefund extends WxPayDataBase
{
	...
	* @param string $param_value 
	**/
	public function SetOut_refund_no($param_value)
	{
		$this->values['out_refund_no'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetRefund_fee($param_value)
	{
		$this->values['refund_fee'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetRefund_fee_type($param_value)
	{
		$this->values['refund_fee_type'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetOp_user_id($param_value)
	{
		$this->values['op_user_id'] = $param_value;
	}
	/**
	* 获取操作员帐号, 默认为商户号的值
	* @return 值
...
class WxPayRefundQuery extends WxPayDataBase
{
	...
	* @param string $param_value 
	**/
	public function SetRefund_id($param_value)
	{
		$this->values['refund_id'] = $param_value;
	}
	/**
...
class WxPayDownloadBill extends WxPayDataBase
{
	...
	* @param string $param_value 
	**/
	public function SetBill_date($param_value)
	{
		$this->values['bill_date'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetBill_type($param_value)
	{
		$this->values['bill_type'] = $param_value;
	}
	/**
...
class WxPayReport extends WxPayDataBase
{
	...
	* @param string $param_value 
	**/
	public function SetInterface_url($param_value)
	{
		$this->values['interface_url'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetExecute_time_($param_value)
	{
		$this->values['execute_time_'] = $param_value;
	}
	/**
	* 获取接口耗时情况，单位为毫秒的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetReturn_code($param_value)
	{
		$this->values['return_code'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetReturn_msg($param_value)
	{
		$this->values['return_msg'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetResult_code($param_value)
	{
		$this->values['result_code'] = $param_value;
	}
	/**
	* 获取SUCCESS/FAIL的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetErr_code($param_value)
	{
		$this->values['err_code'] = $param_value;
	}
	/**
	...
	* @param string $param_value 
	**/
	public function SetErr_code_des($param_value)
	{
		$this->values['err_code_des'] = $param_value;
	}
	/**
	* 获取结果信息描述的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetUser_ip($param_value)
	{
		$this->values['user_ip'] = $param_value;
	}
	/**
	* 获取发起接口调用时的机器IP 的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetTime($param_value)
	{
		$this->values['time'] = $param_value;
	}
	/**
...
class WxPayShortUrl extends WxPayDataBase
{
	...
	* @param string $param_value 
	**/
	public function SetLong_url($param_value)
	{
		$this->values['long_url'] = $param_value;
	}
	/**
...
class WxPayMicroPay extends WxPayDataBase
{
	...
	* @param string $param_value 
	**/
	public function SetAuth_code($param_value)
	{
		$this->values['auth_code'] = $param_value;
	}
	/**
...
class WxPayJsApiPay extends WxPayDataBase
{
	...
	* @param string $param_value 
	**/
	public function SetTimeStamp($param_value)
	{
		$this->values['timeStamp'] = $param_value;
	}
	/**
	* 获取支付时间戳的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetNonceStr($param_value)
	{
		$this->values['nonceStr'] = $param_value;
	}
	/**
	* 获取notify随机字符串值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetPackage($param_value)
	{
		$this->values['package'] = $param_value;
	}
	/**
	* 获取订单详情扩展字符串的值
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetSignType($param_value)
	{
		$this->values['signType'] = $param_value;
	}
	/**
	* 获取签名方式
	* @return 值
	...
	* @param string $param_value 
	**/
	public function SetPaySign($param_value)
	{
		$this->values['paySign'] = $param_value;
	}
	/**
	* 获取签名方式
	* @return 值
...
class WxPayBizPayUrl extends WxPayDataBaseSignMd5
{
	...
	* @param string $param_value 
	**/
	public function SetTime_stamp($param_value)
	{
		$this->values['time_stamp'] = $param_value;
	}
	/**
	* 获取支付时间戳的值
	* @return 值
