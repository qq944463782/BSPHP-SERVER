...
<?php if ((string) Plug_Get_Configs_Value('mobile', 'h5_show') !=='0') {
...
?>
<dd><a target="_blank" href="../h5agent/?resapi=<?php echo rawurlencode($agent_dir); ?>"><?php echo Plug_Lang('H5版访问'); ?></a></dd>
<?php } ?>
...
<script>layui.config({base: '<?php echo Plug_Get_Url_Statics() ?>style/',views:'../statics/default/agent/'}).extend({index: 'lib/index'}).use(['jquery', 'index']);</script>
