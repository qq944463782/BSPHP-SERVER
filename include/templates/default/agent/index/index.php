...
<?php
$h5_show=(string) Plug_Get_Configs_Value('mobile', 'h5_show') !=='0';
$agent_dir=basename(str_replace('\\', '/', dirname(isset($_SERVER['SCRIPT_NAME']) ? $_SERVER['SCRIPT_NAME'] : '/agent')));
if ($agent_dir==='' || $agent_dir==='.' || $agent_dir==='/') {
$agent_dir='agent';
}
?>
<?php if ($h5_show) { ?>
<a class="mobile-link" href="../h5agent/?resapi=<?php echo rawurlencode($agent_dir); ?>"><?php echo Plug_Lang('手机版'); ?></a>
<?php } ?>
</form>
</div>
</div>
