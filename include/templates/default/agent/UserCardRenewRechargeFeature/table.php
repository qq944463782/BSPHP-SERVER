...
<label class="layui-form-label"><?php echo Plug_Lang('充值账户/卡号'); ?></label>
<div class="layui-input-inline" style="width:400px;">
<input type="text" name="user_user" id="user_user" placeholder="<?php echo Plug_Lang('输入充值目标账户/卡号'); ?>" value="<?php echo htmlspecialchars($user_user); ?>" class="layui-input">
</div>
</div>
<div class="layui-form-item">
