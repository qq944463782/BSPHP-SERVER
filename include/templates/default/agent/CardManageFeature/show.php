...
<head>
  <meta charset="utf-8">
  <title><?PHP echo Plug_Get_Configs_Value("sys", "name") ?>- <?php echo Plug_Lang('制作的充值卡'); ?></title>
  ...
  <style>
    ...
    .fmt-toolbar .layui-input-inline {
      width: 420px;
    }
    .fmt-quick-btns {
      margin-top: 6px;
...
<body>
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header"><?php echo Plug_Lang('制作的充值卡'); ?></div>
          ...
          <div class="layui-card-body">
            ...
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
              <div class="layui-form-item">
                ...
                <div class="layui-col-md12 fmt-toolbar">
                  <div class="layui-inline">
                    <div class="layui-input-inline">
                      <input type="text" name="css" id="css" value="卡号:{KAID} 密码:{KAPWD} 时间:{CARDAY}天" placeholder="<?php echo Plug_Lang('格式:卡号:{KAID} 密码:{KAPWD} 时间:{CARDAY}天'); ?>" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  <div class="layui-inline">
                    <button id="fmt_apply" type="button" class="layui-btn layui-btn-sm"><?php echo Plug_Lang('应用格式'); ?></button>
                  </div>
                  <div class="fmt-quick-btns">
                    <button type="button" class="layui-btn layui-btn-sm layui-btn-primary fmt-btn" data-fmt="{KAID}"><?php echo Plug_Lang('单卡号'); ?></button>
                    <button type="button" class="layui-btn layui-btn-sm layui-btn-primary fmt-btn" data-fmt="卡号:{KAID} 密码:{KAPWD}"><?php echo Plug_Lang('卡号+密码'); ?></button>
                    <button type="button" class="layui-btn layui-btn-sm layui-btn-primary fmt-btn" data-fmt="卡号:{KAID} 密码:{KAPWD} 时间:{CARDAY}天"><?php echo Plug_Lang('标准'); ?></button>
                    <button type="button" class="layui-btn layui-btn-sm layui-btn-primary fmt-btn" data-fmt="{KAID}----{KAPWD}"><?php echo Plug_Lang('卡号----密码'); ?></button>
                    <button type="button" class="layui-btn layui-btn-sm layui-btn-primary fmt-btn" data-fmt="{KAID}\t{KAPWD}"><?php echo Plug_Lang('Tab分隔'); ?></button>
                    <button type="button" class="layui-btn layui-btn-sm layui-btn-primary fmt-btn" data-fmt="{KAID},{KAPWD},{CARDAY}"><?php echo Plug_Lang('CSV'); ?></button>
                  </div>
                </div>

                <div style="margin-top:10px;" class="layui-col-md12">
                  <textarea name="csshow" id="csshow" style="height:300px;" placeholder="<?php echo Plug_Lang('排版结果'); ?>" class="layui-textarea"><?php echo $tset ?></textarea>
                </div>

                <button onclick="savefiles()" id="kami_txt" type="button" style="margin-top: 10px;" class="layui-btn layui-btn-normal"><?php echo Plug_Lang('导出TXT') ?></button>
                <button id="kami_copy" type="button" style="margin-top: 10px;" class="layui-btn layui-btn-normal"><?php echo Plug_Lang('复制全部卡密') ?></button>
                <button onclick="input_select()" id="kami_allse" type="button" style="margin-top: 10px;" class="layui-btn layui-btn-normal"><?php echo Plug_Lang('全选卡密') ?></button>
  ...
  <script>
    layui.config({
      ...
      var renderByFmt = function(fmt) {
        var rows = parseCardRows(sourceText);
        var out = [];
        for (var i = 0; i < rows.length; i++) {
          var line = fmt;
          line = line.replace(/\{KAID\}/g, rows[i].KAID);
          line = line.replace(/\{KAPWD\}/g, rows[i].KAPWD);
      ...
      window.savefiles = function() {
        ...
        save_link.download = '导出卡密<?php echo PLUG_DATE(); ?>.txt';
        save_link.click();
      };
