...
<p class="layui-word-aux"><?php echo ��������������������������������������������������������������������������������('账号限时模式(演示默认这个):账号顾名思义就是用户可以注册自己账号密码进行登录,限时如今天是2018.11.16号,我软件到期时间2018.11.20号,超过20号就无法再继续使用'); ?></p>
<p class="layui-word-aux"><?php echo ��������������������������������������������������������������������������������('账号扣点模式:账号顾名思义就是用户可以注册自己账号密码进行登录,如用户账号里有100点，用户登录一次扣一个点/执行一个功能任务扣一个点直至扣完'); ?></p>
<p class="layui-word-aux"><?php echo ��������������������������������������������������������������������������������('卡限时模式:用户一般嫌弃麻烦,软件作者只需要后台生成一个激活卡发用户,用户直接拿这张卡进行验证(登录)使用,比登录账号模式减少注册方便快捷实用,限时如今天是2018.11.16号,我软件到期时间2018.11.20号,超过20号就无法再继续使用'); ?></p>
