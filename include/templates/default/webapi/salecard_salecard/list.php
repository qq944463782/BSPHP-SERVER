...
<head>
  ...
  <title><?php echo Plug_Lang('全部软件 - 购买现卡'); ?></title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .app-tag{display:inline-block;margin-top:6px;padding:2px 8px;border-radius:999px;font-size:12px;background:#fef3c7;color:#92400e}
...
<body class="w<?php echo $wrap_mode; ?>">
  <div class="wrap">
    <div class="hd">
      <h1><?php echo Plug_Lang('全部软件 - 购买现卡'); ?></h1>
      <p><?php echo Plug_Lang('选择软件后进入现卡购买页面，支付后从库存中分配卡密。'); ?></p>
    </div>
    <div class="app-list">
      ...
      <?php } else {
        foreach ($app_list as $a) {
          $detail_url = 'index.php?m=webapi&c=salecard_salecard&a=index&daihao=' . (int)$a['app_daihao'];
          if ($u !== '') {
      ...
      <a class="app-item" href="<?php echo htmlspecialchars($detail_url); ?>">
        ...
        <div class="app-info">
          ...
          <span class="app-tag"><?php echo Plug_Lang('购买现卡'); ?></span>
        </div>
