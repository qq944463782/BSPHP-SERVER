...
<body class="w<?php echo $wrap_mode; ?>">
  <div id="app">
    ...
    <div class="wrap">
      ...
      <!-- 标签页导航 -->
      <div class="tabs-nav">
        <div :class="['tabs-nav-item', {active: activeTab==='login'}]" data-tab="login" @click="selectTab('login')">登录</div>
  ...
  <script>
    ...
    (function() {
      ...
      // 标签页顺序，用于 #tbas=0 / #tabs=0 或 ?tbas=0 / ?tabs=0 跳转（0=登录 1=注册 2=解绑定 3=充值 4=改密码 5=找回密码 6=反馈问题）
