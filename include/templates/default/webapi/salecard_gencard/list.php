...
<head>
  ...
  <title><?php echo Plug_Lang('全部软件 - 购买卡密'); ?></title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .app-tag{display:inline-block;margin-top:6px;padding:2px 8px;border-radius:999px;font-size:12px;background:#ecfdf5;color:#047857}
...
<body class="w<?php echo $wrap_mode; ?>">
  <div class="wrap">
    <div class="hd">
      <h1><?php echo Plug_Lang('全部软件 - 购买卡密'); ?></h1>
      <p><?php echo Plug_Lang('选择软件后进入卡密购买页面，支付后系统自动生成卡密。'); ?></p>
    </div>
    <div class="app-list">
      ...
      <?php } else {
        foreach ($app_list as $a) {
          $detail_url = 'index.php?m=webapi&c=salecard_gencard&a=index&daihao=' . (int)$a['app_daihao'];
          if ($u !== '') {
      ...
      <a class="app-item" href="<?php echo htmlspecialchars($detail_url); ?>">
        ...
        <div class="app-info">
          ...
          <span class="app-tag"><?php echo Plug_Lang('购买卡密'); ?></span>
        </div>
