...
<api>
  ...
  <params>
    ...
    <param name="user" required="false" type="string" desc="通过账号密码方式直接验证"></param>
    <param name="pwd" required="false" type="string" desc="通过账号密码方式直接验证"></param>
  </params>
</api>
*/
