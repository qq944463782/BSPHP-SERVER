...
/*
<api>
  <name>login_sms.lg</name>
  <title>手机短信验证码登录</title>
    <intro>接口参数说明</intro>
  ...
  <params>
    ...
    <param name="maxoror" required="false" type="string" desc="参数说明"></param>
...
Plug_Add_AppenLog('user_login_log', Plug_Lang('短信登录 账号:') . $user . Plug_Lang(' 机器码:') . $key . Plug_Lang(' 多开机器码:') . $maxoror, $user);
