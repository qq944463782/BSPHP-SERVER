...
<api>
  ...
  <params>
    <param name="balance" required="false" type="string" desc="扣除金额"></param>
    <param name="table" required="false" type="string" desc="扣除日志标题，xxx原因消费扣除"></param>
  </params>
</api>
*/
