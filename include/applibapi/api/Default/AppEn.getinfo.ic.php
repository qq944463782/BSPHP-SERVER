...
<api>
  ...
  <params>
    <param name="ic_carid" required="false" type="string" desc="通过登录卡号获取验证"></param>
    <param name="ic_pwd" required="false" type="string" desc="卡密码"></param>
    <param name="info" required="false" type="string" desc="需要获取信息字段"></param>
    <param name="type" required="false" type="string" desc="type=1 直接返回数组"></param>
  </params>
</api>
*/
