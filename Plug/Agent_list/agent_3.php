...
<a href="javascript:;" lay-href="index.php?m=agent&c=main&a=info" class="layui-this" lay-tips="<?php echo Plug_Lang('中控台'); ?>中控台" lay-direction="0">
<i class="layui-icon layui-icon-home"></i>
<cite><?php echo Plug_Lang('中控台'); ?>中控台</cite>
</a>
</li>
...
<li data-name="get" class="layui-nav-item">
<a href="javascript:;" lay-href="index.php?m=agent&c=sp&a=add" lay-tips="<?php echo Plug_Lang('余额制卡'); ?>" lay-direction="5">
