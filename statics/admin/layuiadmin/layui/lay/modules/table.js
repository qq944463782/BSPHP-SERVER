        ...
        F.prototype.config = {
            ...
            F.prototype.pullData = function (e) {
                ...
                if (i.startTime = (new Date).getTime(), a.url) {
                    ...
                    r['bsphptime'] = (new Date).getTime();


                    r['soso_id'] = document.getElementById("soso_id").value;


                    r['soso'] = document.getElementById("soso").value;


                    r['DESC'] = document.getElementById("DESC").value;
                    ...
                    a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)),
                        ...
                        t.ajax({
                            ...
                            error: function (e, t) {
                                ...
                                i.layMain.html('<div class="' + f + '">数据接口请求异常：' + e.responseText + "</div>"),
            ...
            F.prototype.renderData = function (e, n, o, r) {
                ...
                return c.key = s.id || s.index,
                    ...
                    r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">' + s.text.none + "</div>")) : (m(), c.renderTotal(u), void (s.page && (s.page = t.extend({
                        ...
                        limits: s.limits || [10, 30, 50, 100, 200, 500, 1000, 2000, 5000],
            ...
            F.prototype.fullSize = function () {
                ...
                t.fullHeightGap && (a = H.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height", 'auto!important;')),


                    a && (e = parseFloat(a) - (t.layHeader.outerHeight() || 38), i.toolbar && (e -= t.layTool.outerHeight() || 50), i.totalRow && (e -= t.layTotal.outerHeight() || 40), i.page && (e = e - (t.layPage.outerHeight() || 41) - 2), t.layMain.css("height", e <= 200 ? 300 : e))
