        ...
        u.prototype.view = function () {
            ...
            var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1
                , i = {
                    ...
                    count: typeof Bsphp_G_TO !== "undefined" ?'<span class="layui-laypage-count">' + Bsphp_G_ALL + ' ' + a.count + " " +  Bsphp_G_E + "</span>":'<span class="layui-laypage-count">共 ' + a.count + " 条</span>",
                    limit: function () {
                        var e = ['<span class="layui-laypage-limits"><select lay-ignore>'];
                        return layui.each(a.limits, function (t, n) {

                            if (typeof Bsphp_G_TO !== "undefined") {
                                e.push('<option value="' + n + '"' + (n === a.limit ? "selected" : "") + ">" + n + " " + Bsphp_G_E + "/" + Bsphp_G_P + "</option>")
                            } else {
                    ...
                    skip: function () {
                        ...
                        if (typeof Bsphp_G_TO !== "undefined") {
                            return ['<span class="layui-laypage-skip"' + Bsphp_G_TO, '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', Bsphp_G_P + '<button type="button" class="layui-laypage-btn">' + Bsphp_G_OK +'</button>', "</span>"].join("")
                        } else {
